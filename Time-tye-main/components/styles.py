...
def apply_styles(login: bool = False) -> None:
    ...
    if login_background:
        ...
        .stTabs [data-testid="stWidgetLabel"] *,
        .stTabs [data-testid="stFileUploaderDropzone"] label {{
            color: #ffffff !important;
            font-weight: 800 !important;
    ...
    st.markdown(
        ...
        .stProgress > div > div > div > div { background-color: #15803d !important; }
        @media (max-width: 640px) {
            .block-container { padding:1rem .85rem 2rem; }
            .hero { padding:1.4rem; border-radius:20px; }
            .hero h1 { font-size:2.2rem; }
            .stat-card { min-height: 95px; padding: 0.85rem 0.9rem; }
        ...
        <meta name="theme-color" content="#102a27">
        """,
